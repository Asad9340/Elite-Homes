...
function Estates({ estate }) {
  ...
  return (
    <div className="relative mb-10">
      <img
        className="rounded-lg z-10 h-[350px] md:h-[400px] w-full"
        src={image}
        alt=""
      />
      <p className="text-xs  rounded-xl flex flex-col items-center justify-center absolute top-12 -left-1 px-6 py-3 bg-primary text-textSecondary -rotate-45">
      ...
      <div className="-mt-4 hover:absolute hover:-mt-20 duration-300 bg-secondary text-textSecondary hover:bg-red-500 z-40 w-full px-4 md:px-6 py-6 md:py-8 rounded-b-lg">
        ...
        <p className="mt-3 animate__animated animate__backInRight animate__delay-1s ">
          Name: {name}
        </p>
