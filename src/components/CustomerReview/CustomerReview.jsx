    ...
    <div className="max-w-6xl">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-3 m-8">
        ...
        >
          ...
          <div className="grid py-4 w-full  overflow-x-scroll rounded-lg lg:overflow-visible">
        ...
        >
          <div className="flex gap-2 items-center">
            {' '}
            <img className="w-12 rounded-full border h-12" src="" alt="" />
            <h3 className="text-xl font-semibold">Jayed</h3>
          </div>
          <div className="grid py-4 w-full  overflow-x-scroll rounded-lg lg:overflow-visible">
            <div className="inline-flex items-center">
              <span>
        ...
        >
          <div className="flex gap-2 items-center">
            {' '}
            <img className="w-12 rounded-full border h-12" src="" alt="" />
            <h3 className="text-xl font-semibold">Emon</h3>
          </div>
          <div className="grid py-4 w-full  overflow-x-scroll rounded-lg lg:overflow-visible">
            <div className="inline-flex items-center">
              <span>
        ...
        >
          <div className="flex gap-2 items-center">
            {' '}
            <img className="w-12 rounded-full border h-12" src="" alt="" />
            <h3 className="text-xl font-semibold">Inzamam</h3>
          </div>
          <div className="grid py-4 w-full  overflow-x-scroll rounded-lg lg:overflow-visible">
            <div className="inline-flex items-center">
              <span>
        ...
        >
          <div className="flex gap-2 items-center">
            {' '}
            <img className="w-12 rounded-full border h-12" src="" alt="" />
            <h3 className="text-xl font-semibold">Nasir</h3>
          </div>
          <div className="grid py-4 w-full  overflow-x-scroll rounded-lg lg:overflow-visible">
            <div className="inline-flex items-center">
              <span>
