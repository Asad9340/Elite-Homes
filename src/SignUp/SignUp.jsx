  ...
  return (
    <div className="flex justify-center items-center">
      <div className="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
        ...
        <p className="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700 text-center">
          Nice to meet you! Enter your details to register.
        </p>
        <form onSubmit={handleRegistration} className="mt-2 mb-2 w-80 sm:w-96">
          <div className="flex flex-col gap-6 mb-1">
            <h6 className="block -mb-7 font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-blue-gray-900">
              Your Name
            </h6>
